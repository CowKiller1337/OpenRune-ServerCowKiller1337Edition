...
public data class InstanceSettings(
    ...
    val graceWarningThresholds: List<Int>? = null,
    val graceExpiryMessage: String? = null,
    ...
    public fun withArea(area: InstanceArea, settingsRowId: Int): InstanceSpec =
        InstanceSpec(
            ...
            graceWarningThresholds = graceWarningThresholds,
            graceExpiryMessage = graceExpiryMessage,
