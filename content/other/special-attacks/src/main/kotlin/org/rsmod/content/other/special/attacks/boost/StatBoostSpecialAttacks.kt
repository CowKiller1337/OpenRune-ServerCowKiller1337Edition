...
class StatBoostSpecialAttacks @Inject constructor(private val worldRepo: WorldRepository) :
    ...
    override fun SpecialAttackRepository.register(manager: SpecialAttackManager) {
        ...
        registerInstant("obj.league_trailblazer_harpoon", ::fishstabberInfernalHarpoonOr)
        ...
        registerInstant("obj.league_trailblazer_pickaxe", ::rockKnockerInfernalPickaxeOr)
